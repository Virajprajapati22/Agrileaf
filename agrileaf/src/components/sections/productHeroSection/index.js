      ...
      <section className="bg-green-700 m-[2em] border-2 border-green-900 rounded-[1em]">
          <div className="mx-auto hula-w-7xl py-16 px-6 lg:flex lg:items-center lg:justify-between lg:px-8">
              <div className="lg:w-1/2">
                  ...
                  <div className="mt-6">
                      <Link href="/solutions/sol" className="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
